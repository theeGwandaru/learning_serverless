...
export default function Welcome() {
    return (
        ...
        <article class="content">
          ...
          <p>The original Landon perseveres after 50 years in the heart of West London.
          ...
          &nbsp;To learn more about the Landon Hotel in the West End, browse our website and
